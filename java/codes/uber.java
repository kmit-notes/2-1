...
class User extends Ride{
    ...
    String name;
    int phone;
    // User(String name,String start,String end,double kms){
    //     // super(name,start,end,kms);
    // }
    ...
    void requestsRide(){
        ...
        // this(name,start,end,kms);
        super.requestingRide(name,start,end,kms);
    ...
    void driverAssigned(){
        ...
        for (int i=0;i<d.length;i++){
            if (d[i].isAvailable){
                ...
                System.out.println("Driver is not available.Requesting another driver.");
                // Driver d=new Driver()
            }
        }
...
class Ride extends Driver{
    ...
    double fare;
    String status;
    // Driver d1=new Driver(1,"Shyam","sedan");
    // Driver d2=new Driver(2,"Ram","hatchback");
